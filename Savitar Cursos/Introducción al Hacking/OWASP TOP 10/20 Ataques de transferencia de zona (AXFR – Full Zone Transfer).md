- Tags : #recursos_github #tools #reconocimiento_tools #dig_tool
...
**IXFR** Se transfiere la informacion parcial de la ZONA partiendo de la ultima transferencia realizada
...
```bash
svn  https://github.com/vulhub/vulhub/trunk/dns/dns-zone-transfer
```


Dig para hacer reconocimiento de dominios
```bash
Transferencia copleta de zonas
dig axfr @ip dominio

dig axfr @127.0.0.1 savicorp.local

axfr -> Tipo de transferencia de zona completa
ixfr -> Tipo de transferencia de zona parcial

#Enumerara os name servers
dig ns @127.0.0.1 savicorp.local

#Enumeracion de los servidores de correo
dig mx @127.0.0.1 savicorp.local
