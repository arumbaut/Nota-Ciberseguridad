...
**DAVTEST** -> Se necesitan conocer credenciales del webdav
...
```bash
davtest -url http://ip -auth admin:admin
...
```bash
apt install cadaver
#Solicita las credenciales que las obtnemos con davtest o de alguna otra manera
cadaver http://dir
```