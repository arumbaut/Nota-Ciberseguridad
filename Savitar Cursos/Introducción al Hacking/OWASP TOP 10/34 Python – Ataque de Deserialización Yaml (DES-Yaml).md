- Tags : #python #python_deserializacion_yaml #python_deserializacion_yaml 

**Recurso**: **SKF-LABS DES-Yaml**: [https://github.com/blabla1337/skf-labs/tree/master/python/DES-Yaml](https://github.com/blabla1337/skf-labs/tree/master/python/DES-Yaml)
...
**Recirsos** : [https://book.hacktricks.wiki/en/pentesting-web/deserialization/python-yaml-deserialization.html](https://book.hacktricks.wiki/en/pentesting-web/deserialization/python-yaml-deserialization.html)

[https://www.pkmurphy.com.au/isityaml/](https://www.pkmurphy.com.au/isityaml/)
