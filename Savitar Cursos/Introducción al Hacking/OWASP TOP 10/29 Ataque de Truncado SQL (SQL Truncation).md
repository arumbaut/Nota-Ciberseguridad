- Tags : #sql #sql_truncation #recursos #recursos_vulnhub 

**Recurso**: **Máquina Tornado de Vulnhub**: [https://www.vulnhub.com/entry/ia-tornado,639/](https://www.vulnhub.com/entry/ia-tornado,639/)
...
Básicamente es intentar utilizar las limitaciones del lado del cliente para truncar la entrada y forzar a que la base de datos haga cosas que no debe. 
![](../../../attachments/Pasted%20image%2020260218112422.png)

Modificamos el limite en el lado del cliente para truncar la base de datos e intentamos utilizar algún usuario existente para modificar su password.
![](../../../attachments/Pasted%20image%2020260218112812.png)