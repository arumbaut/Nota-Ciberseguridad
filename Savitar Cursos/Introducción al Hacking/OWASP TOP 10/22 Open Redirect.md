...
**Recurso Potente**: [https://github.com/epsylon/ufonet](https://github.com/epsylon/ufonet)

Para https no es necesario poner las 2 barras en la dirección 
```Ejemplo
https://url/redirect.php?url=https:www.google.com
```