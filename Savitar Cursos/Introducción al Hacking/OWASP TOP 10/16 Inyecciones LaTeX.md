- Tags : #latex_injections #recursos_github #payloads_all_the_things 
...
- **PayloadAllTheThings** :[https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/LaTeX%20Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/LaTeX%20Injection
- [https://swisskyrepo.github.io/PayloadsAllTheThings/LaTeX%20Injection/](https://swisskyrepo.github.io/PayloadsAllTheThings/LaTeX%20Injection/)

```bash

apt install textlive-full -y 
apt install zathura latexmk rubber -y 
apt install poppler-utils -y  #Permite convertir pdf a texto

xdg-mime query default application/pdf
xdg-mime default zathira.desktop application/pdf


svn checkout https://github.com/internetwache/Internetwache-CTF-2016/tree/master/tasks/web90/code
cd code
mv * /var/www/html
cd !$
mc config.php.example config.php
