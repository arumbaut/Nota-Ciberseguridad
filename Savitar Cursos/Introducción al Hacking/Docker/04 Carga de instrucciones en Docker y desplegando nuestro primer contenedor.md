...
```
docker run -dit --name Mi_Contenedor imagen_base

d  Poner en 2 plano
i  Correr en modo interactivo
t  Nos da una tty para interactuar

Conectarnos a la consola virtual creada
...
```
docker build -t mi_primer_imagen:v2 .
```
