...
docker images : muestra las imagenes que tenemos en el sistema

docker ps : muestra los contenedores que estan en ejecucion 
docker ps -a : muestra todos los contenedores 

docker param --help : muestra la ayuda del parametro 

docker stop id_container : detiene el contenedor