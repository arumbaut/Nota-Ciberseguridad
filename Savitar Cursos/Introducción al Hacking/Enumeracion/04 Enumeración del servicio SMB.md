- Tags :  #smb #enumeration #recursos_github
...
SMBCLIENT
```
Listar recursos utilizando el null session 

smbclient -L ip -N

-L   listar recursos compartidos
-N   Indica que utilice null session

Conectar al recurso utilizando el null session

smbclien //ip/nombre_recurso -N

Para navegar de mejor manera por el recurso compartido podems montarlo en nuestra maquina utilizando cifs-utils
apt install cifs-utils

mount -t cift //ip/recurso /mnt/mounted -o usernema=null,password=null,domain=,rw  

mount -t cift //ip/recurso /mnt/mounted 
