- Tags : #escalada #escalada_privilegios #escalada_privilegios_linux #escalada_privilegios_linux_abuso_binarios  #debug_sh #debug_gdb #debug_peda
...
**Wrappers**  Sirve para ver el código PHP que se esta ejecutando 

![](../../../attachments/Pasted%20image%2020260223101847.png)

Para debuguear binarios .sh podesmos utilizar gdb , se instala mediante apt y peda clonamos el repo.

**Repo** : [https://github.com/longld/peda](https://github.com/longld/peda)
