...
- **Immunity Debugger**: [https://immunityinc.com/products/debugger/](https://immunityinc.com/products/debugger/)  Depurador de 32 bits para Windows. Se utiliza para analizar los binarios, para ver  los registros que escribimos, ver la pila 
- **mona.py**: [https://raw.githubusercontent.com/corelan/mona/master/mona.py](https://raw.githubusercontent.com/corelan/mona/master/mona.py) . El script de mona .py debemos meterlo en la carpeta donde esta instalado Immunity `C:\Program Files\Immunity Inc\Immunity Debugger\PyCommands`
