...
==Una máquina puede enviar una respuesta ARP incluso sin haberla solicitado; además, puede aceptar tal respuesta. Cuando una máquina quiere esnifar el tráfico originado desde otro sistema, puede hacer un ARP spoofing al gateway de la red. La caché ARP de la máquina objetivo tendrá una entrada incorrecta para el gateway. Por lo tanto, todo el tráfico destinado a pasar por el gateway pasará ahora por la máquina que falsificó la dirección MAC del gateway.==
