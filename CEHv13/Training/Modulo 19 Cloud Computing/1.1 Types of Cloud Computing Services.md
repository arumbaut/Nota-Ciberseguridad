...
==Este servicio de computación en la nube proporciona una plataforma para desarrollar, ejecutar y gestionar las funcionalidades de las aplicaciones sin la complejidad de construir y mantener la infraestructura necesaria (arquitectura sin servidor)==. ==Este modelo se utiliza principalmente en el desarrollo de aplicaciones para microservicios. Proporciona funcionalidad bajo demanda a los suscriptores que desconecta la infraestructura de soporte y no genera cargos cuando no se utiliza==. Ofrece servicios de procesamiento de datos, como servicios del Internet de las Cosas (IoT) para dispositivos conectados, aplicaciones móviles y web, y procesamiento por lotes y flujos (p. ej., AWS Lambda, Google Cloud Functions, Microsoft Azure Functions y Oracle Functions).

#### **▪ Firewalls-as-a-Service (FWaaS)**
Este servicio de computación en la nube protege a usuarios y organizaciones de amenazas internas y externas mediante el filtrado del tráfico de red. FWaaS incluye capacidades mejoradas de análisis de datos, incluyendo la capacidad de detectar ataques de malware, además de funciones de seguridad como filtrado de paquetes, análisis de red e IPsec (p. ej., Zscaler Cloud Firewall, SecurityHQ, Secucloud, Fortinet, Cisco y Sophos).