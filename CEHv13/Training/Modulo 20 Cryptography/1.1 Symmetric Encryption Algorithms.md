...
**▪ RC4**RC4 es un cifrado de flujo simétrico con tamaño de clave variable, orientado a operaciones por byte y basado en el uso de una permutación aleatoria. RC4 permite comunicaciones seguras, como el cifrado del tráfico (que protege sitios web) y sitios web que utilizan el protocolo SSL. Basado en la factorización del producto de dos grandes números primos? 
